...
export function SearchCommand({ ...props }: DialogProps) {
  ...
  return (
    <>
      <Button
        className="relative h-9 w-72 justify-start rounded-full bg-background/40 text-sm text-white shadow-none backdrop-blur-md supports-backdrop-blur:bg-background/90 sm:min-w-sm lg:min-h-12 lg:min-w-md"
      ...
      >
        ...
        <div className="ml-auto hidden gap-1 sm:flex">
          <CommandMenuKbd className="bg-transparent">
            {isMac ? '⌘' : 'Ctrl'}
          </CommandMenuKbd>
          <CommandMenuKbd className="aspect-square bg-transparent">
            K
          </CommandMenuKbd>
        </div>
      </Button>
